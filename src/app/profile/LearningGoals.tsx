    ...
    <form onSubmit={handleSubmit}>
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center space-x-2">
            <Input
              ...
              className="w-24"
            />
            <span className="text-gray-500">minutes per day</span>
          </div>
          <p className="text-xs text-gray-500">Recommended: 15-60 minutes</p>
        </div>
        
        {/* Weekly Days Goal */}
        <div className="space-y-2">
          <Label htmlFor="weeklyGoalDays">Weekly Frequency (days)</Label>
          <div className="flex items-center space-x-2">
            <Input
              id="weeklyGoalDays"
              type="number"
          ...
          <p className="text-xs text-gray-500">Recommended: 3-7 days</p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-gray-500">Select subjects you want to focus on</p>
        </div>
